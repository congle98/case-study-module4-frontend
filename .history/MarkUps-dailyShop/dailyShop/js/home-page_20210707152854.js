    ...
    $.ajax({
        ...
        success: function (data){
            ...
            for (let i = 0; i < data.length; i++) {
               content += "<tr><td>"+data[i].name+"</td>"+"<td>"+data[i].address+"</td>"+"<td>"+data[i].phoneNumber+"</td>"+"<td>"+data[i].status+"</td>"+"<td>"+data[i].shopName+"</td><td><a href="index.html">"+data[i].shopN+"</td></tr>"
              };
