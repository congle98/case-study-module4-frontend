...
function renderCartOrder(orderDetail){
    let content = "<div class=\"aa-cartbox-summary\"><ul>"
    let allDivCartBox = document.getElementsByClassName('aa-cartbox-summary-all');
    for (let i = 0; i <orderDetail.length;i++){
        ...
        "<div class=\"aa-cartbox-info\">"+
          ...
          "<p>"+orderDetail.quantity+" x "+orderDetail.product.sale_price+"</p>"+
        "</div>"+
        "<a class=\"aa-remove-product\" href=\"#\"><span class=\"fa fa-times\"></span></a></li>"
    }
    content +=  "</ul><a class=\"aa-cartbox-checkout aa-primary-btn\" href=\"#\">Checkout</a></div>"
