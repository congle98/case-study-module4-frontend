...
function renderCartOrder(orderDetails){
    ...
    console.log(allDivCartBox.length)
    ...
    //       "<p>"+orderDetails[i].quantity+" x "+orderDetails[i].product.sale_price+"</p>"+
    //     "</div>"+
    //     "<a class=\"aa-remove-product\" href=\"#\"><span class=\"fa fa-times\"></span></a></li>"
    // }
    content += "<li><span class=\"aa-cartbox-total-title\">  Total"+
    "</span><span class=\"aa-cartbox-total-price\"> $500</span>"+
    "</li></ul><a class=\"aa-cartbox-checkout aa-primary-btn\" href=\"#\">Checkout</a></div></div>";

//   for (let i = 0; i <allDivCartBox.length;i++){
//     allDivCartBox[i].innerHTML=content;
//     }
