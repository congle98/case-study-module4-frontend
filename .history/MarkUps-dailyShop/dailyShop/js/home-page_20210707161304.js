...
function renderAllUser(data){
    ...
    for (let i = 0; i < data.length; i++) {
       ...
       data[i].status+"</td>"+"<td>"+data[i].shopName+"</td><td><button type=\"button\" onclick=\"changeStatusUser("+data[i].userName+")\"class=\"btn btn-warning\">"+data[i].status+"</button></td></tr>"
      };
