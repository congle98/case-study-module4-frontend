...
function checkoutData(){
    ...
    for (let i = 0; i < orderDetails.orderDetailList.length; i++){
        ...
        content += "<tr> <td>"+orderDetails.orderDetailList[i].product.name+"<strong> x "+orderDetails.orderDetailList[i].quantity+"  </strong></td><td>"+orderDetails[i].product.salePrice+"</td></tr>"
    }
