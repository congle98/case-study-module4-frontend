...
function checkOutButton(){
    let orderList = JSON.parse(localStorage.getItem("cartOrder"));
    let content = "<div class=\"aa-order-summary-area\">"+
    "<table class=\"table table-responsive\">"+
      "<thead><tr><th>Product</th><th>Total</th></tr></thead><tbody>"
    let totalPrice  
    for (let i = 0; i < orderList.length; i++){
        content += "<tr> <td>"+orderList[i].product.name+"<strong> x "+orderList[i].quantity+"  </strong></td><td>"+orderList[i].salePrice+"</td></tr>"
    }
