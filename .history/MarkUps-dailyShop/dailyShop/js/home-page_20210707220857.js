    ...
    $.ajax({
        ...
        success: function (data){
            ...
            for (let i = 0; i < data.length; i++) {
               ...
               mencontent+= "</ul><a class=\"aa-browse-btn\" href=\"#\">Browse all Product <span class=\"fa fa-long-arrow-right\"></span></a></div>";
               womencontent+="</ul><a class=\"aa-browse-btn\" href=\"#\">Browse all Product <span class=\"fa fa-long-arrow-right\"></span></a></div>";
        
                document.getElementById('men').innerHTML = mencontent;
                document.getElementById('women').innerHTML = mencontent;
