...
function finAllProductByCategory(){
    $.ajax({
        ...
        success: function (data){
            console.log(data);
            let mencontent = "<div class=\"tab-pane fade in active\" id=\"men\">"+data;
            ...
            for (let i = 0; i < data.length; i++) {
             ...
             "</ul>"
               ...
               mencontent+= "<a class=\"aa-browse-btn\" href=\"#\">Browse all Product <span class=\"fa fa-long-arrow-right\"></span></a></div>"
